...
1. 推荐直接使用 JS 动态覆写：`https://raw.githubusercontent.com/Latticect/override-rules/refs/heads/main/convert.js`
...
```
https://raw.githubusercontent.com/Latticect/override-rules/refs/heads/main/convert.js#landing=true
```
